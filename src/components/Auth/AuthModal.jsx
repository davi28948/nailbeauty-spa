...
import { X, User, Phone, Lock, LogIn, UserPlus, Sparkles, Loader2, Eye, EyeOff, Shield, Heart, Star } from 'lucide-react'
...
export default function AuthModal({ isOpen, onClose, isRequired }) {
  ...
  return (
    <div className="fixed inset-0 z-[10000]">
      {/* Fondo oscuro */}
      <div className="absolute inset-0 bg-black/60 backdrop-blur-md" onClick={() => !isRequired && onClose()} />
